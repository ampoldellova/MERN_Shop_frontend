...
export const logout = () => async (dispatch) => {
    try {
        ...
        await axios.get(`http://localhost:4001/api/v1/logout`, config)
        dispatch({
            type: LOGOUT_SUCCESS,
        })
    } catch (error) {
...
export const updatePassword = (passwords) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`http://localhost:4001/api/v1/password/update`, passwords, config)
        dispatch({
...
export const forgotPassword = (email) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`http://localhost:4001/api/v1/password/forgot`, email, config)
        dispatch({
...
export const allUsers = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:4001/api/v1/admin/users`, {
...
export const deleteUser = (id) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.delete(`http://localhost:4001/api/v1/admin/user/${id}`, { withCredentials: true })
        dispatch({
